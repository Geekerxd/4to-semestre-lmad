#include "cangrejo.h"
cangrejo::cangrejo(char* path, WCHAR texture[])
...
void cangrejo::Draw(float x, float y, float z, float Sx, float Sy, float Sz, float angle,
