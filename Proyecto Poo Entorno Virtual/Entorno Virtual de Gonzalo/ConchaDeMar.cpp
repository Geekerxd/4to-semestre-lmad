...
ConchaDeMar::ConchaDeMar(char* path, WCHAR texture[])
...
ConchaDeMar::~ConchaDeMar()
{
	if (_model)
		delete _model;
}

void ConchaDeMar::Draw(float x, float y, float z, float Sx, float Sy, float Sz, float angle,
...
Vector3 ConchaDeMar::GetPosition()
{
	return _position;
}
